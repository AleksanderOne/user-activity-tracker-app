...
const CREDENTIAL_PATTERNS = {
  ...
  // Pola z hasłami
  password: [/pass(word)?/i, /haslo/i, /has[łl]o/i, /secret/i, /pwd/i, /pin/i],
  // Numery telefonów
  phone: [/phone/i, /tel(efon)?/i, /mobile/i, /komórka/i, /numer/i],
  // Numery kart
  card: [/card/i, /karta/i, /cc_?num/i, /cvv/i, /cvc/i, /expir/i],
  ...
  // Adresy
  address: [/address/i, /adres/i, /street/i, /ulica/i, /city/i, /miasto/i, /zip/i, /kod_pocztowy/i],
  // Dane osobowe
  personal: [
    /name/i,
    /imie/i,
...
function classifyField(
  fieldName: string,
  fieldValue: string,
): { type: string; confidence: 'high' | 'medium' | 'low' } | null {
  ...
  if (
    VALUE_PATTERNS.bank_account.test(fieldValue) ||
    VALUE_PATTERNS.bank_account.test(cleanedValue)
  ) {
