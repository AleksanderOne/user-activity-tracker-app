...
export default function TrackingControlPage() {
  ...
  return (
    <DashboardContent>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-white mb-2">🛡️ Kontrola Śledzenia</h1>
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500 mt-0.5">
                        {site.enabled
                          ? globalSettings?.enabled
                            ? '✅ Śledzone'
                            : '⏸️ Globalnie wyłączone'
                          : '❌ Wyłączone'}
                        {site.updated_at &&
                          ` • Zmieniono: ${new Date(site.updated_at).toLocaleDateString('pl-PL')}`}
                      </div>
                    </div>
                  </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <div className="flex items-center gap-3 justify-center md:justify-start mb-2">
              ...
              <h2 className="text-2xl font-bold text-white">Śledzenie Globalne</h2>
            </div>
            <p
        ...
        {!globalSettings?.enabled && (
          <div className="mt-6 bg-red-900/30 border border-red-800 rounded-lg p-4">
            <p className="text-red-300 text-sm flex items-center gap-2">
              ...
              <span>
                <strong>Uwaga:</strong> Gdy śledzenie globalne jest wyłączone, żadne dane z żadnej
                strony nie będą zbierane, nawet jeśli dana strona ma włączone indywidualne
                śledzenie.
              </span>
            </p>
          </div>
      ...
      <div className="mt-8 bg-slate-900/30 border border-slate-800 rounded-xl p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 text-sm text-slate-400">
          <div>
            ...
            <p>
              Główny wyłącznik całego systemu. Gdy jest{' '}
              <strong className="text-red-400">WYŁĄCZONY</strong>, żadne dane nie są zbierane z
              żadnej strony - niezależnie od ustawień indywidualnych.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              Działa tylko gdy śledzenie globalne jest{' '}
              <strong className="text-emerald-400">WŁĄCZONE</strong>.
            </p>
          </div>
        </div>
        <div className="mt-4 p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg">
          <p className="text-amber-400 text-sm">
            💡 <strong>Tip:</strong> Tracker.js na stronach może sprawdzić status przed wysłaniem
