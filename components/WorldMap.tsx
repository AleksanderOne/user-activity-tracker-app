...
const WORLD_PATH = `M167,89L168,90L172,89L176,91L177,93L181,94L184,93L187,95L190,94L192,91L196,90L199,91L201,94L199,97L201,100L199,103L196,105L193,104L190,106L187,105L184,107L181,106L178,108L175,107L172,109L169,108L166,110L163,109L160,111L157,110L154,112L151,111L148,113L145,112L142,114L139,113L136,115L133,114L130,116L127,115L124,117L121,116L118,118L115,117L112,119L109,118L106,120L103,119L100,121L97,120L94,122L91,121L88,123L85,122L82,124L79,123L76,125L73,124L70,126L67,125L64,127L61,126L58,128L55,127L52,129L49,128L46,130L43,129L40,131L37,130L34,132L31,131L28,133L25,132L22,134L19,133L16,135L13,134L10,136L7,135L4,137L1,136L-2,138L-5,137L-8,139L-11,138L-14,140L-17,139L-20,141L-23,140L-26,142L-29,141L-32,143L-35,142L-38,144L-41,143L-44,145`;
        ...
        <div className="relative" onMouseMove={handleMouseMove}>
            ...
            <div className="flex gap-4 mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-slate-400">Aktywne: <span className="text-emerald-400 font-bold">{data.stats.active}</span></span>
                </div>
                <div className="flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-slate-500"></span>
                    <span className="text-sm text-slate-400">Nieaktywne: <span className="text-slate-300 font-bold">{data.stats.inactive}</span></span>
                </div>
            ...
            <div className="relative bg-slate-900/80 rounded-xl border border-slate-700 overflow-hidden">
                <svg 
                    ...
                    style={{ minHeight: '300px', background: 'linear-gradient(180deg, #0f172a 0%, #1e293b 100%)' }}
                >
                    <defs>
                ...
                {hoveredPin && (
                    ...
                    >
                        <div className="flex items-center gap-2 mb-3">
                            <span className={`w-3 h-3 rounded-full ${hoveredPin.is_active ? 'bg-emerald-500 animate-pulse' : 'bg-slate-500'}`}></span>
                            <span className="font-bold text-white text-lg">{hoveredPin.country}</span>
                            {hoveredPin.city && (
                                <span className="text-slate-400">• {hoveredPin.city}</span>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                            ...
                            <span className="text-purple-400 font-mono text-xs">{hoveredPin.site_id.substring(0, 12)}...</span>
                        ...
                        <div className={`mt-3 pt-3 border-t border-slate-700 text-sm font-medium ${
                    ...
                    {Object.entries(data.countries)
                        ...
                        .map(([country, counts]) => (
                            ...
                            >
                                ...
                                {counts.inactive > 0 && (
                                    <span className="text-slate-500">{counts.inactive}</span>
                                )}
                            </span>
                        ))
                    }
